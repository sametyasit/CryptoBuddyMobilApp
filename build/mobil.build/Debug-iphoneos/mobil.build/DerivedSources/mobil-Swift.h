...
#ifndef MOBIL_SWIFT_H
#define MOBIL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="mobil",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5mobil11AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC5mobil13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC5mobil14ViewController")
